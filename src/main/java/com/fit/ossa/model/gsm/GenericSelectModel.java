package com.fit.ossa.model.gsm;
...
public class GenericSelectModel<T> extends AbstractSelectModel implements
	...
	public GenericSelectModel(Collection<T> list, Class<T> clazz,
			String labelField, String idField, PropertyAccess access) {
		this.list = list;
		if (idField != null)
	...
	public void addOptionGroup(String label, boolean disabled, List<T> options) {
		...
		ArrayList<OptionGroupModel> optionGroups = new ArrayList<OptionGroupModel>();
